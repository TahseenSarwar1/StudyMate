...
import { BookOpen, ChevronLeft, Play, CheckCircle2, Lock } from 'lucide-react';
...
function ChapterSkeleton() {
  return (
    <div className="glass-card p-5 bg-white border border-slate-100 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 animate-pulse">
      <div className="flex items-start space-x-4 pl-1 flex-1">
        <div className="w-5 h-5 mt-1 bg-slate-200 rounded-full" />
...
export default function ChapterList() {
  ...
  const { chapters: chapterList, loading } = useChapters(subjectId);
    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <div className="space-y-3">
          {loading ? (
            [...Array(5)].map((_, i) => <ChapterSkeleton key={i} />)
          ) : (
            <>
